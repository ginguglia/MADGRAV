...
# gated injection chains and regenerate the detections table. Logs to launchers/gnet_after_nullcal.log.
...
echo "[orch] detections table (gated)"
SM_FAR_LR_CSV=figures/catalog_o3o4/far_lronly_g106_gnet.csv SM_KE_JSON=$DET/ke_gnet.json \
SM_PASTRO_CSV=search_mode/pastro_final/pastro_final_x1cnnadopt48fg.csv SM_TABLE_OUT=paper_search/detections_table_gnet.tex \
  $PY paper_search/make_table_adopted.py
