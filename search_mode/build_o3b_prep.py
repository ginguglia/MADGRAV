...
WN = 4 * FS
NPERSEG = 1024
STRAIN = os.environ.get("SM_STRAIN", os.path.join(os.environ.get("SCRATCH", "."), "strain_o3b_full"))
OUT = os.environ.get("SM_PREP_OUT", os.path.join(os.environ.get("MADGRAV_ROOT", "."), "data/o3b_search_prep"))
